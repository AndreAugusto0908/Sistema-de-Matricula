  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      const alunoDTO = {
        ...
        documento: alunoSelecionado.documento,
        curso: alunoSelecionado.curso,
        senha: "",      // Pode mandar vazio se não tiver aqui
        endereco: "",   // Pode mandar vazio se não tiver
        email: "",      // Pode mandar vazio
        rg: ""          // Pode mandar vazio
      };
